...
public class SearchArticlesController extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    String url = "search_articles.jsp";
    try {
      ...
      ArrayList<ArticlesDTO> articles = dao.searchArticlesUsers(keyword, 20, page);

      int totalOfArticles = dao.countArticlesUser(keyword);
      int totalOfPages = Ultis.convertToPages(totalOfArticles, 20);
      System.out.println(articles.size());
      System.out.println(totalOfArticles);
